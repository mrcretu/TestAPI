...
namespace OMRO.Helpers
{
    public class SecurityHeadersBuilder
    {
        ...
        /// <summary>
        /// Builds a new <see cref="SecurityHeaderPolicy"/> using the entries added.
        /// </summary>
        /// <returns>The constructed <see cref="SecurityHeaderPolicy"/>.</returns>
